    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2d$components$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
            function startProcessFlow() {
                ...
                let index = 0;
                setInterval({
                    "Page.useEffect.startProcessFlow": ()=>{
                        steps.forEach({
                            "Page.useEffect.startProcessFlow": (s)=>s.classList.remove("glow")
                        }["Page.useEffect.startProcessFlow"]);
                        steps[index]?.classList.add("glow");
                        index = (index + 1) % steps.length;
                    }
                }["Page.useEffect.startProcessFlow"], 1000);
            }
...
//# sourceMappingURL=website-components_app_page_tsx_b9a6e6bb._.js.map